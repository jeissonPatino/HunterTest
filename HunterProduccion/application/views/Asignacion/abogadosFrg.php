	...
	<div class="box">
        ...
        <div class="box-body">
    	 	<div class="row">
    	 		...
    	 		<div class="col-sm-4">
            <label>
                <input type="checkbox" name="optionsRadios" id="poliza" value="option3">Información póliza
            </label>  
          </div>
    	 	</div>
    	</div><!-- /.box-body -->
    ...
    <div class="box-body">
            ...
            <div class="form-group">
          	...
          	<div class="form-group">
              	...
              	<div class="col-sm-10">
                	  <select id="cmbAbogadosMas" name="cmbAbogadosMas" class="form-control">
...
<div class="box" id="carguePoliza" style="display:none;">
    <div class="box-header with-border">
      <h3 class="box-title">Información de la poliza</h3>
    </div>
    <div class="box-body">
        <form class="form-horizontal" action="<?php echo base_url(); ?>asignacion/carguemasPoliza" method="POST" id="formCargeMasivoAbogados2" enctype="multipart/form-data">
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Asignado por:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label for="FilExcell2" class="col-sm-2 control-label">Archivo a Subir</label>
                <div class="col-sm-10">
        ...
        <div class="box-footer">
            <button type="reset" id="ResetForm12" class="btn btn-default" >Cancelar</button>
            <button type="button" id="btncarguedos2" class="btn btn-primary">Cargar datos de póliza</button>
        </div><!-- /.box-footer -->
    </div><!-- /.box -->
</div>
              ...
              alertify.confirm("¿Esta seguro de esta operación?", function (e) {
                if (e) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        data: { txtnumeroSap :  $("#txtnumeroSap").val(), cmbAbogados: $("#cmbabogados").val(), filtro : $("#cmbFiltros2").val() },
              ...
              alertify.confirm("¿Esta seguro de esta operación?", function (e) {
                  if (e) {
                    ...
                    $.ajax({
                        ...
                        url: '<?php echo base_url(); ?>asignacion/carguemasABogados',  
                        type: 'POST',
                        data: formData,
                        cache: false,
                        contentType: false,
