<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Obligaciones</li>
    </ol>
</section>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" >GESTIONES EXTRAJUDICIALES</h4>
            </div>
			    ...
			    <div class="box-body">
					<div class="panel box box-primary">
						...
						<div id="collapseOne" class="panel-collapse collapse">
							<div class="box-body ">
								<div row="row-fluid">
									<div class="col-md-2 table-responsive no-padding">
			                ...
			                <div class="tab-content no-padding">
			                  	...
			                  	<div class="chart tab-pane" id="medidas2" style="position: relative; height: auto;">
									...
									<form class="form-horizontal">
										...
										<div class="form-group">
											<label for="txtObservacionesFechas" class="col-sm-9 control-label">Observaciones</label>
											<div class="col-sm-9">
...
var idUsuario;
	...
	$(function(){
	    ...
	    $("#RowContrato td").click(function(){
	    	...
	    	$.ajax({
	    		url     : '<?php echo base_url();?>auxiliar/getIdContrato/'+$(this).html(),
	    		type    : 'POST',
	    		success : function(data){
	    			var dato = data;
			    	...
			    	/*$.ajax({
			    		...
			    		type   : 'POST',
			    		data   : {contrato: dato , usuario: idUsuario },
			    		success  : function(data){
			    			$("#txtRol").html(data);
			    		}
			    	});*/
