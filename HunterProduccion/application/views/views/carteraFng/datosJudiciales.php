...
<section class="content">
   ...
   data-keyboard="false" >
								        				<img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-71.png" style=" width: 100%; height: auto;" id="logoHunter">
								        			</a>
												</div>
												<div class="col-md-4">
									...
									<form class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<div class="checkbox">
													<label>
														<input type="radio" name="Calificacionesobligaciones"  value="SI">
														Si
													</label>
												</div>
												...
												<div class="checkbox">
													<label>
														<input type="radio" name="Calificacionesobligaciones" value="NO">
														No
													</label>
												</div>
											</div>
