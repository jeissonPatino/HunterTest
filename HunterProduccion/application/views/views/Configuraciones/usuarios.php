									...
									<div class="box-body">
										<div class="row">
											...
											<div class="col-lg-6">
												...
												<div class="checkbox">
													<label>
														<input type="checkbox" name="cargar_subrogaciones_permisos_" disabled value="1">
														Cargar Subrogaciones
													</label>
												</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#agregar").click(function(){
			...
			$('input[name=cargar_subrogaciones_permisos_]').prop('disabled', false);
		...
		$("#cancel").click(function(){
			...
			$('input[name=cargar_subrogaciones_permisos_]').prop('disabled', true);
			...
			$('input[name=cargar_subrogaciones_permisos_]').prop('checked', false);
	...
	function getdatosAqui(codigo){
		var varid = codigo;
			...
			$.getJSON('<?php echo base_url();?>configuraciones/getDatosUsuario/'+varid, {format: "json"}, function(data) { 
                ...
                if(data[0].cargar_subrogaciones_permisos_ == '1'){
                	$('input[name=cargar_subrogaciones_permisos_]').attr('checked', true);
                }
