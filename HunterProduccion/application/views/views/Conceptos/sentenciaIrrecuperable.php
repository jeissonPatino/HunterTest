<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Sentencia Irrecuperable</li>
    </ol>
</section>
        ...
        <div class="box-body">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-left">
                    <li class="active"><a id="tab2" href="#descargue" data-toggle="tab">Descarga de sentencias irrecuperables</a></li>
                    <li ><a id="tab1" href="#cargue" data-toggle="tab">Carga de sentencias irrecuperables</a></li>
                    
                </ul>
                <div class="tab-content no-padding">
                    <!-- ESTE ES EL BLOQUE QUE CARGA LA INFORMACIÓN -->  
                    <div class="chart tab-pane" id="cargue" style="position: relative; height: auto;">
                    ...
                    <div class="chart tab-pane active" id="descargue" style="position: relative; height: auto;">
                        <div class="box-header with-border">
                          <h3 class="box-title">
                        ...
                        <div class="box" id="cargueOculto" style="display: none;">
                            ...
                            <table class="table table-hover table-bordered" id="tablaRara" >
                              <thead>
                                    <tr>
                                        <th>No. Contrato</th>
                                        <th>Fecha Subrogaci&oacute;n</th>
	...
	$(function () {
        ...
        $("#gestoresAsignacionMavo").click(function(){
            ...
            $.ajax({
                ...
                url: '<?php echo base_url(); ?>Conceptos/cargar_sentencia_irrecuperable',  
                type: 'POST',
                data: formData,
                cache: false,
                contentType: false,
        ...
        $("#gestoresAsignacionMavoDescargue").click(function(){
            ...
            $.ajax({
                ...
                url: '<?php echo base_url(); ?>Conceptos/descargar_sentencia_irrecuperable',  
                type: 'POST',
                data: formData,
                cache: false,
                contentType: false,
                ...
                success: function(data){
                    ...
                    $("#tablaRara").DataTable({
                        ...
                        "aoColumns": [
                          { mData: "Ncontrato" },
                          { mData: "fecha"},
                          { mData: "fecha_sentencia"},
                          { mData: "fecha_liquidacion"},
                          { mData: "valor" }
