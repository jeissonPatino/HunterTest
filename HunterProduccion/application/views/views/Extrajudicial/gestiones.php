			...
			if(isset($vista)){
				switch ($vista) {
					...
					//viene de Clientes nuevos
						echo ' CARTERA FNG - CLIENTES NUEVOS';	
						break;
					case '3':
					//viene de clientes con datos nuevos
						echo ' CARTERA FNG - CLIENTES CON DATOS NUEVOS';
						break;

					case '4':
					//viene de clientes con acuerdo de pago
						echo ' CARTERA FNG - CLIENTES CON ACUERDO DE PAGO';
						break;

					case '5':
					//viene de clientes quince dias sin gestin
						echo 'GESTION CARTERA FNG - CLIENTES SIN GESTIÓN POR MAS DE 15 DÍAS';
						break;

					case '6':
					//viene de mis clientes vigentes
						echo 'CARTERA FNG - MIS CLIENTES VIGENTES';
						break;

					case '7':
					//viene de cartera exfuncionario
						echo 'CARTERA FNG - CARTERA EXFUNCIONARIOS';
						break;

					case '8':
					//viene de Obligaciones Vendidas
						echo 'CARTERA FNG - OBLIGACIONES VENDIDAS';
						break;

					case '9':
					//viene de Paz y salvo
						echo 'CARTERA FNG - OBLIGACIONES PAZ Y SALVO';
						break;

					case '11':
					//viene de PBusqueda Avanzadas
						echo 'CARTERA FNG - BÚSQUEDA AVANZADA';
						break;
					case '12':
					//viene de PBusqueda <=12.5SMLLV
						echo 'CARTERA FNG - <= 12.5 SMLMV';
						break;
					case '13':
					//viene de PBusqueda <=12.5SMLLV
						echo 'CARTERA FNG - > 12.5 SMLMV <= $25 M ';
						break;
					case '14':
					//viene de PBusqueda <=12.5SMLLV
						echo 'CARTERA FNG - > $25 M <= $50 M ';
						break;
					case '15':
					//viene de PBusqueda <=12.5SMLLV
						echo 'CARTERA FNG - > $50 M <= $100 M ';
						break;

					case '16':
					//viene de PBusqueda <=12.5SMLLV
						echo 'CARTERA FNG - > $100  M ';
						break;
				}
			}else{
				//viene de Clientes nuevos
	...
	<section class="content">
		<?php 
			...
			if(isset($vista)){
				switch ($vista) {
					...
					case '12':
					//viene de PBusqueda <=12.5SMLLV
						echo '<a href="'.base_url().'extraJudicial/clientesmenosdedoce" class="btn btn-primary"> &nbsp; Volver &nbsp;</a>';
						break;
					case '13':
					//viene de PBusqueda <=12.5SMLLV
						echo '<a href="'.base_url().'extraJudicial/clientesmasdedocemenosveinticinco" class="btn btn-primary"> &nbsp; Volver &nbsp;</a>';
						break;
					case '14':
					//viene de PBusqueda <=12.5SMLLV
						echo '<a href="'.base_url().'extraJudicial/clientesmasdeveinticincomenoscincuenta" class="btn btn-primary"> &nbsp; Volver &nbsp;</a>';
						break;
					case '15':
					//viene de PBusqueda <=12.5SMLLV
						echo '<a href="'.base_url().'extraJudicial/clientesmasdecincuentamenoscien" class="btn btn-primary"> &nbsp; Volver &nbsp;</a>';
						break;

					case '16':
					//viene de PBusqueda <=12.5SMLLV
						echo '<a href="'.base_url().'extraJudicial/clientesmascien" class="btn btn-primary"> &nbsp; Volver &nbsp;</a>';
						break;
				}
			}else{
				//viene de Clientes nuevos
							...
							<div class="row-fluid">
								...
								<div class="col-md-12"> 
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												<label for="txtNumero">No. de liquidaciones deudor</label>
						                 	</div>
										</div>
										<div class="col-md-3">
										...
										<tbody>
											<?php
												/*foreach ($contratos as $contrato) {
													if($contrato->liquidacion != '' && !is_null($contrato->liquidacion)){
									                    echo "<tr><td style='cursor:pointer;' contrato ='".$contrato->No_CONTRATO."'>".$contrato->liquidacion." ".$contrato->financiero ."</td></tr>";
									                }else{
												...
												if($masliquidaciones > 0){
														...
														if(!is_null($contratos[$i])){
															if($contratos[$i]['contrato']!= ''){
															    ...
															    $query = $this->db->get();
															 	...
															 	echo "<tr><td style='cursor:pointer;' contrato ='".$query->row()->Id."'>".$contratos[$i]['contrato']." ".$query->row()->NombreIF ."</td></tr>";
													...
													for($i=0;$i < count($contratos); $i++){
														if(!is_null($contratos[$i])){
														 	...
														 	echo "<tr><td style='cursor:pointer;' contrato ='".$contratos[$i]['No_CONTRATO']."'>".$contratos[$i]['contrato']." ".$contratos[$i]['if'] ."</td></tr>";
	   ...
	   data-keyboard="false" >
									        				<img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-70.png" style=" width: 100%; height: auto;" id="logoHunter">
									        			</a>
													</div>
	   ...
	   data-keyboard="false" >
									        				<img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-72.png" style=" width: 100%; height: auto;" id="logoHunter">
									        			</a>
													</div>
													<div class="col-md-3">
														<a href="#"  data-toggle="modal" data-target="#Modal-Menu-Extrajudicial-Total" data-backdrop="static" 
	   data-keyboard="false" >
									        				<img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-69.png" style=" width: 100%; height: auto;" id="logoHunter">
									        			</a>
													</div>										

													<div class="col-md-3">
														<a href="<?php echo base_url();?>assets/libreto/LIBRETO_CALL_CENTER.pdf" target="_blank">
									        				<img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-68.png" style=" width: 100%; height: auto;" id="logoHunter">
									        			</a>
													</div>
										...
										<div id="collapseSix" class="panel-collapse collapse ">
											<div class="box-body table-responsive no-padding">
											  	<table width="100%;" class="table table-hover table-bordered" id="tblAcuerdoPago">
													<thead>
														<tr>
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="Modal-Menu-Extrajudicial-Total">
	    <div class="modal-dialog  modal-lg">
	        <div class="modal-content">
	            <div class="modal-header">
	                <button aria-label="Close" id="cerrarExtrajudicialTotal" class="close" type="button"><span aria-hidden="true">×</span></button>
	                <h4 class="modal-title" >Gestión ExtraJudicial</h4>
	            </div>
	            <div class="modal-body" >
	            	<div class="nav-tabs-custom">
		                ...
		                <div class="tab-content no-padding">
		                  	<!-- Morris chart - Sales -->
		                  	<div class="chart tab-pane active" id="revenue-chart-tabtotal" style="position: relative; height: auto;">
		                  		...
		                  		<div class="row" id="opcionesDeudortabtotal" >
		                  			<div class="col-md-3">
		                  				<a  onclick="javascript: getdatosTabtabtotal1(1792);"><img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-55.png" style=" width: 100%; height: auto;" id="logoHunter"></a>
		                  			</div>
		                  			<div class="col-md-3">
		                  				<a  onclick="javascript: getdatosTabtabtotal1(1793);"><img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-56.png" style=" width: 100%; height: auto;" id="logoHunter"></a>
		                  			</div>
		                  			<div class="col-md-3">
		                  				<a  onclick="javascript: getdatosTabtabtotal1(1794);"><img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-57.png" style=" width: 100%; height: auto;" id="logoHunter"></a>
		                  			</div>

		                  			<div class="col-md-3">
		                  				<a  onclick="javascript: getdatosTabtabtotal1(1795);"><img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-58.png" style=" width: 100%; height: auto;" id="logoHunter"></a>
		                  			</div>
		                  		</div>
		                  		<div class="row" >
		                  			<div class="col-md-12">
		            		...
		            		<div class="chart tab-pane" id="revenue-chart-tabtotal2" style="position: relative; height: auto;">
		            			<div class="row" >
		                  			<div class="col-md-12">
		                  				&nbsp;
		                  			</div>
		            			...
		            			<div class="row" >
		                  			...
		                  			<div class="col-md-3">
		                  				<a  onclick="javascript: getdatosTabtabtotal2(1780);"><img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-59.png" style=" width: 100%; height: auto;" id="logoHunter"></a>
		                  			</div>
		                  			<div class="col-md-3">
		                  				<a  onclick="javascript: getdatosTabtabtotal2(1781);"><img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-60.png" style=" width: 100%; height: auto;" id="logoHunter"></a>
		                  			</div>
		                  			<div class="col-md-3">
		                  				&nbsp;
		                  			</div>
		            		...
		            		<div class="chart tab-pane" id="revenue-chart-tabtotal3" style="position: relative; height: auto;">
		            			<div class="row" >
		                  			<div class="col-md-12">
		                  				&nbsp;
		                  			</div>
		            			...
		            			<div class="row" id="localizadotabtotal" style="display:none;">
		                  			<div class="col-md-3">
		                  				<a  onclick="javascript: getdatosTabtotal3(1782);"><img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-61.png" style=" width: 100%; height: auto;" id="logoHunter"></a>
		                  			</div>
		                  			<div class="col-md-3">
		                  				<a onclick="javascript: getdatosTabtotal3(1783);"><img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-62.png" style=" width: 100%; height: auto;" id="logoHunter"></a>
		                  			</div>
		                  			<div class="col-md-3">
		                  				<a onclick="javascript: getdatosTabtotal3(1784);"><img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-63.png" style=" width: 100%; height: auto;" id="logoHunter"></a>
		                  			</div>
		                  			<div class="col-md-3">
		                  				<a onclick="javascript: getdatosTabtotal3(1785);"><img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-64.png" style=" width: 100%; height: auto;" id="logoHunter"></a>
		                  			</div>
		                  		</div>

		                  		<div class="row" id="Ilocalizadosquitotal" style="display:none;">
		                  			<div class="col-md-4" id="IlocalizadosquiGestionestotal">
		                  				Subgestiones :*
		                  			</div>
		                  			<div class="col-md-8">
		                  				<div class="form-group">
		                  					<label for="txtObservaciones">Observaciones</label>
		                  					<textarea class="form-control" id="txtObservacionesExtrajudiciales2total"></textarea>
		                  				</div>
		                  				<button class="btn" data-toggle="modal" data-target="#Modal-tareas">Agregar Nueva Tarea</button>
		                  			</div>
		                  		</div>
		                  		<div class="row" id="Ilocalizado2total" style="display:none;">
		                  			<div class="col-md-4">
		                  				<button class="btn" id="btnguardarSaltandoUltimototal">Guardar</button>
		                  			</div>
		                  			<div class="col-md-8">
		            		...
		            		<div class="chart tab-pane" id="revenue-chart-tabtotal4" style="position: relative; height: auto;">
		            			<div class="row" >
		                  			<div class="col-md-12">
		                  				&nbsp;
		                  			</div>
		            			...
		            			<div class="row" >
		                  			<div class="col-md-7" id="subgestionesFinalestotal">
		                  				Subgestiones :*
		                  			</div>
		                  			<div class="col-md-5">
		                  				<div class="form-group">
		                  					<label for="txtObservaciones">Observaciones</label>
		                  					<textarea class="form-control" id="txtObservacionesExtrajudicialestotal"></textarea>
		                  				</div>
		                  				<button class="btn" data-toggle="modal" data-target="#Modal-tareas">Agregar Nueva Tarea</button>
		                  			</div>
		                  		</div>
		                  		<div class="row">
		                  			<div class="col-md-4">
		                  				<button class="btn" id="btnGuardarExtrajudicialtotal">Guardar</button>
		                  			</div>
		                  			<div class="col-md-8">
	            ...
	            <div class="modal-footer">
	                <button id="cerrarModalExtrajudicialTotal" class="btn btn-default pull-left" type="button">Cerrar</button>
	            </div>
	        </div><!-- /.modal-content -->
	    </div><!-- /.modal-dialog -->
	</div>
	...
	var valoragadoFNG = 0;
		...
		$(function(){
	        ...
	        $("#butoncierreSimulador").click(function(){
				...
				var fechaFormateada = fachasimulador.split("/");
				var resta  = restaFechas(fechaFormateada[2] + "-"+ fechaFormateada[1] + "-"+ fechaFormateada[0], fechaLiquidacionEsta[2] + "-"+ fechaLiquidacionEsta[1] + "-"+ fechaLiquidacionEsta[0]);
				//console.log(resta);
			...
			$("#btnCalcular2Simulador").click(function(){
				...
				var fechaFormateada = fachasimulador.split("/");
				console.log(fechaFormateada[0] + "-"+ fechaFormateada[1] + "-"+ fechaFormateada[2]);
				console.log(fechaLiquidacionEsta[0] + "-"+ fechaLiquidacionEsta[1] + "-"+ fechaLiquidacionEsta[2]);
				var resta  = restaFechas(  fechaFormateada[0] + "-"+ fechaFormateada[1] + "-"+ fechaFormateada[2], fechaLiquidacionEsta[0] + "-"+ fechaLiquidacionEsta[1] + "-"+ fechaLiquidacionEsta[2]);
				...
				*/
				...
				var resltao = getValorCuota( estoaqui, 0.13, $("#txtNumeroCuotas").val(), finalis);
				console.log(resltao);
				$("#valordelascuotasSimulador").html("$ "+ formatNumber.new(resltao.toFixed(0)));
			...
			$("#btnGuardarExtrajudicialtotal").click(function(){
				alertify.confirm("¿Esta seguro que desea guardar el registro?", function (e) {
				    if (e) {
			         	$.ajax({
		                    url       : '<?php echo base_url();?>cartera_fng/guardarExtrajudicialTotal',
		                    type      : 'POST',
		                    data      : {
		                                  subgestion : $('input:radio[name=cafeSeleccionadoTotal]:checked').val() ,
		                                  identificacion: <?php echo $identificacion;?>,
		                      
		                                  gestion : gestion,
		                                  resultadocomunicacion  : resultadocomunicacion ,
		                                  mediocomunicacion : comunicacion,
		                                  txtObservaciones : $("#txtObservacionesExtrajudicialestotal").val()
		                                },
		                    success   : function(data){
		                       if(data == 1){
								...
								//$("#opcionesDeudortabtotal").hide();
							  	$("#txtObservacionesExtrajudicialestotal").val('');
							 	$("input:radio[name=cafeSeleccionadoTotal]").prop("checked", false);
							 	$("#tabtotal2").attr('data-toggle',' ');
							 	$("#tabtotal3").attr('data-toggle',' ');
							 	$("#tabtotal4").attr('data-toggle',' ');
							 	$("#tabtotal1").attr('data-toggle','tab');
							 	$("#tabtotal1").click();
							 	$("#localizadotabtotal").hide();
							
								$("#localizadotabtotal").hide();
								$("#Ilocalizadosquitotal").hide();
								$("#Ilocalizado2total").hide();
							 	$("#Modal-Menu-Extrajudicial-Total").modal('hide');
			...
			$("#btnguardarSaltandoUltimototal").click(function(){
				alertify.confirm("¿Esta seguro que desea guardar el registro?", function (e) {
				    if (e) {
				        $.ajax({
		                    url       : '<?php echo base_url();?>cartera_fng/guardarExtrajudicial2Total',
		                    type      : 'POST',
		                    data      : {
		                                  identificacion: <?php echo $identificacion;?>,
		                                  contrato  : numeroContrato ,
		                                  ...
		                                  resultadocomunicacion  : resultadocomunicacion ,
		                                  mediocomunicacion : comunicacion,
		                                  txtObservaciones : $("#txtObservacionesExtrajudiciales2total").val()
		                                },
		                    success   : function(data){
		                       if(data == 1){
		                          //$("#Modal-Menu-Extrajudicial").modal('hide');
									...
									//$("#opcionesDeudortabtotal").hide();
								  	$("#txtObservacionesExtrajudiciales2total").val('');
								 	$("input:radio[name=cafeSeleccionadoTotal]").prop("checked", false);
								 	$("#tabtotal2").attr('data-toggle',' ');
							 		$("#tabtotal3").attr('data-toggle',' ');
							 		$("#tabtotal4").attr('data-toggle',' ');
			...
			$("#cerrarModalExtrajudicialTotal").click(function(){ 
				alertify.confirm("¿Ésta seguro que desea cerrar sin guardar?", function (e) {
				    if (e) {
			         	//alertify.error("hola");
					$("#txtObservacionesExtrajudicialestotal").val('');
			...
			$("#cerrarExtrajudicialTotal").click(function(){
				alertify.confirm("¿Ésta seguro que desea cerrar sin guardar?", function (e) {
				    if (e) {
			         	//alertify.error("hola");
						//$("#opcionesDeudor").hide();
		...
		function getdatosTabtabtotal1(queQuieresHacerSeleccionado){
			$("#tabtotal2").attr('data-toggle','tab');
			$("#tabtotal2").click();
			comunicacion = queQuieresHacerSeleccionado;
		}

		function getdatosTabtabtotal2(localizadoSeleccionado){
			$("#tabtotal1").attr('data-toggle','');
			$("#tabtotal3").attr('data-toggle','tab');
			resultadocomunicacion = localizadoSeleccionado;

			if(localizadoSeleccionado == 1780){
				$("#localizadotabtotal").show();
				//$("#ilocalizado").hide();
			}else{
				$("#localizadotabtotal").hide();
				$("#Ilocalizadosquitotal").show();
				$("#Ilocalizado2total").show();
				...
				$.ajax({
		            ...
		            data     : { localizadoSeleccionado : localizadoSeleccionado },
		            success  : function(data){
		                $("#IlocalizadosquiGestionestotal").html('Subgestiones :* '+ data);
		            }
		        });
			}
		...
		function getdatosTabtotal3(cafeSeleccionado){
			$("#tabtotal2").attr('data-toggle','');
			$("#tabtotal4").attr('data-toggle','tab');
			gestion = cafeSeleccionado;
			$.ajax({
	            url      : "<?php echo base_url();?>cartera_fng/getSubgestionesTotal",
	            type     : "POST",
	       
	            data     : { cafeSeleccionado : cafeSeleccionado },
	            success  : function(data){
	                $("#subgestionesFinalestotal").html('Subgestiones :* '+ data);
	            }
	        });
