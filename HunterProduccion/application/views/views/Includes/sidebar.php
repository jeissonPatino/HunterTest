        ...
        <ul class="sidebar-menu">
            ...
            <li id="ULconfiguracion" class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <!--<li id="LIGarantias"><a href="<?php echo base_url();?>auxiliar/garantias_pagares"><i class="fa fa-circle-o"></i>GARANTÍAS Y PAGARÉS</a></li>
                    <li id="LIif"><a href="<?php echo base_url();?>auxiliar/if_"><i class="fa fa-circle-o"></i>IF</a></li>
                    
                    <li id="LImedidas"><a href="<?php echo base_url();?>auxiliar/medidas_cautelares"><i class="fa fa-circle-o"></i>MEDIDAS CAUTELARES</a></li>
                    <!---->
            ...
            <li id="ULhistorico" class="treeview">
                <a href="#">
                    <i class="fa fa-cogs"></i> <span>HISTÓRICO</span>
                    <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <?php  if(  $this->session->userdata('USUARI_historico_extrajudicial_p') == '1') { ?>
                    <li id="LIHextrajudicial"><a href="<?php echo base_url();?>historicos/historicoExtraJudicial"><i class="fa fa-circle-o"></i>GESTIONES EXTRAJUDICIALES</a></li>
                    <?php } ?>
                    <?php  if( $this->session->userdata('USUARI_historico_judicial_p') == '1' ) { ?>
                    <li id="LIHjudicial"><a href="<?php echo base_url();?>historicos/historicoJudicial"><i class="fa fa-circle-o"></i>GESTIONES JUDICIALES</a></li>
                    <?php } ?>
            ...
            <li id="ULhistorico_SAP" class="treeview">
                <a href="#">
                    <i class="fa fa-cogs"></i> <span>HISTÓRICO PARA SAP</span>
                    <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                   
                    <li id="LIHextrajudicial_SAP"><a href="<?php echo base_url();?>historicos/gestionExtrajudicial_SAP"><i class="fa fa-circle-o"></i>GESTIONES EXTRAJUDICIALES</a></li>
                    <li id="LIHjudicial_SAP"><a href="<?php echo base_url();?>historicos/historicoJudicial_SAP"><i class="fa fa-circle-o"></i>GESTIONES JUDICIALES</a></li>
                    <li id="LIHmedidas_SAP"><a href="<?php echo base_url();?>historicos/historicoMedidas_SAP"><i class="fa fa-circle-o"></i>GESTIÓN MEDIDAS CAUTELARES</a></li>
                     <li id="LIHmedidas_SAP_SUPER"><a href="<?php echo base_url();?>historicos/superhistoricoSap"><i class="fa fa-circle-o"></i>GESTIÓN TOTAL</a></li>
                </ul>
            </li>
            <?php } ?>
