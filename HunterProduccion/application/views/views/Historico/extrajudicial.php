<section class="content-header">
    <h1>
        ...
        HISTORICO GESTIONES EXTRAJUDICIAL
    </h1>
    <ol class="breadcrumb">
    	<li><a href="<?php echo base_url();?>home">Inicio</a></li>
        <li class="active">Historico gestion extrajudicial</li>
    </ol>
</section>
					...
					<div class="box">
						<div class="box-header">
							<div class="row">
								...
								<div class="col-md-4">
									<a class="btn btn-success" href="<?php echo base_url();?>historicos/exportarExtrajudicial">
...
<script type="text/javascript">
	buscar = {
		extrajudicial : function(estado, gestion, subgestion){
			$.getJSON('<?php echo base_url();?>historicos/gestionExtrajudicialJson/'+ estado +'/'+ gestion +'/'+subgestion, {format: "json"}, function(data) {
