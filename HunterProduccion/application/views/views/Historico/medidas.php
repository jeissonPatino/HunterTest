<section class="content-header">
    <h1>
        ...
        HISTORICO MEDIDAS CAUTELARES
    </h1>
    <ol class="breadcrumb">
    	<li><a href="<?php echo base_url();?>home">Inicio</a></li>
        <li class="active">Historico medidas cautelares</li>
    </ol>
</section>
				...
				<div class="col-md-12">
					<div class="box">
						<div class="box-header">
							...
							<div class="row">
								<div class="col-md-4">
									<a class="btn btn-success" href="<?php echo base_url();?>historicos/exportarHistoricoJudicial">
