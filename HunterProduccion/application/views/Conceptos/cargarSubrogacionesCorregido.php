<section class="content-header">
    <h1>
        Configuración F. Envío M. Subrogación corregido
    </h1>
    <ol class="breadcrumb">
    	<li><a href="<?php echo base_url();?>home">Inicio</a></li>
        <li class="active">Configuración - F. ENVÍO M. SUBROGACIÓN CORREGIDO</li>
    </ol>
</section>
          ...
          if(validador == 0){
              alertify.confirm("¿Esta seguro de esta operación?", function (e) {
                if (e) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url(); ?>conceptos/guardarUnoaUnoCorreccion',  
                        type: 'POST',
              ...
              alertify.confirm("¿Esta seguro de esta operación?", function (e) {
                  if (e) {
                    ...
                    $.ajax({
                        ...
                        url: '<?php echo base_url(); ?>conceptos/cargarCorreccionesSubrogacionesMasiva',  
                        type: 'POST',
                        data: formData,
                        cache: false,
                        contentType: false,
