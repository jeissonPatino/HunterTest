<section class="content-header">
    <h1>
        APLICACIÓN FACTURAS - SUBROGACIONES
    </h1>
    <ol class="breadcrumb">
    	<li><a href="<?php echo base_url();?>home">Inicio</a></li>
        <li class="active">Subrogaciones</li>
    </ol>
</section>
        ...
        <div class="box-body">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-left">
                    <li class="active"><a id="tab2" href="#descargue" data-toggle="tab">Descarga de subrogaciones</a></li>
                    <li ><a id="tab1" href="#cargue" data-toggle="tab">Carga de Subrogaciones</a></li>
	...
	$(function () {
        ...
        $("#gestoresAsignacionMavo").click(function(){
            ...
            $.ajax({
                ...
                url: '<?php echo base_url(); ?>Conceptos/buscarValoresSubrogacion',  
                type: 'POST',
                data: formData,
                cache: false,
                contentType: false,
