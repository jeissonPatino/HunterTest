<section class="content-header">
    <h1>
        CARTERA FNG - MIS PROCESOS IRRECUPERABLES
    </h1>
    <ol class="breadcrumb">
    	<li><a href="<?php echo base_url();?>home">Inicio</a></li>
    	<li><a href="<?php echo base_url();?>cartera_fng">Cartera Fng</a></li>
        <li class="active">Cartera Fng - Procesos Irrecuperables</li>
    </ol>
</section>
					...
					<?php
						...
						/*foreach ($clientes as $key) {
							echo '	<tr  style="cursor:pointer;">
										...
										<td  identificacion ="'.$key->identificacion.'">'.$key->Fecha_Factura.'</td>
										<td  identificacion ="'.$key->identificacion.'">'.$key->No_Factura.'</td>
										<td>
											<a href="'.base_url().'cartera_fng/datosJudiciales/'.$key->identificacion.'/2"  title="información" class="btn btn-sm btn-info">
		...
		$("#tablaJudicial").DataTable({
		        ...
		        "sPaginationType": "simple",
		          ...
		          "buttons": [{
			                  ...
			                  charset: 'utf-8',
			                  extension: '.csv',
		              filename: 'Mis procesos irrecuperables',
		              bom: true
		              }],
	           ...
	           //	"ajax": "<?php echo base_url();?>Cartera_fng/getDatosProcesosVigentes",
				...
				"fnDrawCallback": function (oSettings, json) {
				   ...
				   $(".trobligacion").dblclick(function(){
						...
						window.location.href = "<?php echo base_url();?>cartera_fng/datosJudiciales/"+garantia+"/2";
				   });
				}
	    });
