	...
	<section class="content">
		<?php 
			...
			if(isset($vista)){
				switch ($vista) {
					...
					case '17':
					//viene de PBusqueda <=12.5SMLLV
						echo '<a href="'.base_url().'extrajudicial/busquedaGestion" class="btn btn-primary"> &nbsp; Volver &nbsp;</a>';
						break;
				}
			}else{
				//viene de Clientes nuevos
	   ...
	   data-keyboard="false" >
									        				<img src="<?php echo base_url();?>assets/img/botones/Extrajudicial/botones-70.png" style=" width: 100%; height: auto;" id="logoHunter">
									        			</a>
													</div>
						...
						<div class="box-body">
							<?php foreach ($otrosDatos as $key) {
								echo '<div class="row">
							  	...
							  	<div class="row">
							  		<div class="col-md-3"><label>Tipo identificacion</label></div>
							  		<div class="col-md-3">'.utf8_encode($key->tipo_identificacion).'</div>
							  	</div>'
							  	;
