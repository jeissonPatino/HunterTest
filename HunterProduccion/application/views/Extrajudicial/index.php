	...
	<div class="box">
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-md-8" id ="tablaBotones">
                    <div  class="row">
                        <div class="col-md-3" id ="tablaBotones">
                        ...
                        <div class="col-md-3" id ="tablaBotones">
                            <a  href="<?php echo base_url();?>extrajudicial/clientesConacuerdodepago" >
                                <img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-46-2.png" style=" width: 150px; height: auto;" id="logoHunter">
                            </a>
                        </div>
                    </div>
                    ...
                    <div  class="row">
                        <div class="col-md-4" id ="tablaBotones">
                            <a  href="<?php echo base_url();?>extrajudicial/busquedaEstado" >
                                <img src="<?php echo base_url();?>assets/botones/extrajudicial/botones-74.png" style=" width: 150px; height: auto;" id="logoHunter">
                            </a>
                        </div>
                    </div>
                </div>
