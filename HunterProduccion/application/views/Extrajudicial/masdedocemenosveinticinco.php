<section class="content-header">
    <h1>
        CARTERA FNG - MÁS DE 12.5 SMLMV MENOS DE 25'M
    </h1>
    <ol class="breadcrumb">
    	<li><a href="<?php echo base_url();?>home">Inicio</a></li>
    	<li><a href="<?php echo base_url();?>Extrajudicial">Cartera Fng</a></li>
        <li class="active">Cartera Fng - Más de 12.5 SMLMV menos de 25'M</li>
    </ol>
</section>
	...
	$(function(){
		...
		$("#tablaJudicial").DataTable({
			    ...
			    "buttons": [{
			                  ...
			                  charset: 'utf-8',
			                  extension: '.csv',
							filename: 'Más de 12.5 SMLMV menos de 25.M',
							bom: true
							}],
	           ...
	           //	"ajax": "<?php echo base_url();?>Cartera_fng/getDatosProcesosVigentes",
				...
				"fnDrawCallback": function (oSettings, json) {
				   ...
				   $(".trobligacion").dblclick(function(){
						...
						window.location.href = "<?php echo base_url();?>extrajudicial/gestionar/"+dato+"/13";
				   });
				}
	    });
