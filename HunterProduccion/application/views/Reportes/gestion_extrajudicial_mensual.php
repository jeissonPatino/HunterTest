	...
	<div class="box">
		...
		<div class="box-body">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<a href="<?php echo base_url();?>reportes/exportar_gestion_extrajudicial_mensual" class="btn btn-primary  btn-block" id="btonExportar"><i class="fa fa-file-excel-o"></i>&nbsp;&nbsp;Exportar a Excel</a>
				</div>	
			</div>
		</div>
	</div>
