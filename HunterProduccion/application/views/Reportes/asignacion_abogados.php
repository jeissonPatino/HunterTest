 ...
 <script type="text/javascript">
 	$(function(){
        ...
        $("#BtnBuscarInformes").click(function(){
        	$.ajax({
        		type    : "POST",
        		url     : "<?php echo base_url();?>reportes/getReportesAsignacion_abogados",
        		data    : { frg: $("#cmbFrgs").val(), abogados:$("#cmbAbogados").val() ,fechainicial:$("#reservation").val() , fechafinal: $("#reservationfinal").val()},
        		success : function (data){
        			$("#Resultadobusqueda").html(data);

        			$("#btonExportar").attr('href', '<?php echo base_url();?>reportes/exportarAsignacionAbogados/'+ $("#cmbFrgs").val() + "/" + $("#cmbAbogados").val() + "/" + $("#reservation").val() + "/" + $("#reservationfinal").val() );
        			$("#btonExportar").show();
        		}
        	});
        });
