<?php
  ...
  $totalNoCumple =$sinradicarFueradeTiempo+ $radicadosFueradetiempo;
	$label = "['Base de medición', 'Obligaciones que cumplen', 'Obligaciones que no cumplen']";
    $data1 = "['".$totalObligaciones."' , '".$cumplimiento."', '".$totalNoCumple."']";
