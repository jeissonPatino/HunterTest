									...
									<?php
										foreach ($frg as $key) {
											echo '<tr style="cursor:pointer;">
													<td class="tdMinimo" onclick=" getdatos('.$key->G729_ConsInte__b.');">'.utf8_encode($key->Frg).'</td>
												  	<td class="tdMinimo" onclick=" getdatos('.$key->G729_ConsInte__b.');">'.utf8_encode($key->telefono).'</td>
												  </tr>';
										}
									?>
								</tbody>
