...
class CarteraFng_Model extends CI_Model {
    ...
    function getDatosbusquedaAvanzada($filtro = null){
        ...
        $this->db->join('G737' , 'dbo.G717.G717_ConsInte__b = dbo.G737.G737_C17181','LEFT');
        $this->db->join('G719' , 'dbo.G737.G737_C17182 = dbo.G719.G719_ConsInte__b','LEFT');
