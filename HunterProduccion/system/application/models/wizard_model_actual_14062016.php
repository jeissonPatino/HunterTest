...
class Wizard_Model extends CI_Model {
    ...
    function getGestionIlocalizado($gestion){
        $this->db->select('G732_c17130 as gestion, G732_c17131 as enunciado ');
        $this->db->where('G732_C17129', $gestion); 
    ...
    function getgestioJudicialById($contrato){
        ...
        $this->db->where('G735_ConsInte__b', $contrato); 
        $query = $this->db->get('G735');
        return $query->result();
    }
    ...
    function getInformacionAbogado($contrato){
		...
		$this->db->join('G723', 'G723_ConsInte__b = G719_C17153');
