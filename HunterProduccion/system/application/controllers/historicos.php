...
class Historicos extends CI_Controller {
    ...
    public function gestionExtrajudicialJson($estado, $gestion, $subgestion){
        if($this->session->userdata('login_ok')){
            $extrajudicial = $this->Wizard_Model->getgestionExtrajudicialtotal($estado, $gestion, $subgestion);
            $abogados =array();
            $i = 0;
            foreach ($extrajudicial as $key) {
                $fecha1 = null;
    ...
    public function gestionExtrajudicialJson_e($estado, $gestion, $subgestion){
        if($this->session->userdata('login_ok')){
            $extrajudicial = $this->Wizard_Model->getgestionExtrajudicialtotal2($estado, $gestion, $subgestion);
            $abogados =array();
            $i = 0;
            foreach ($extrajudicial as $key) {
                $fecha1 = null;
    ...
    public function exportarExtrajudicial(){
        ini_set('memory_limit', '1024M');
        $extrajudicial = $this->Wizard_Model->getgestionExtrajudicialtotal();
    ...
    public function historicoJudicialjson($proceso, $etapa, $actuacion){
        if($this->session->userdata('login_ok')){
            ini_set('memory_limit', '512M');

            $extrajudicial = $this->Wizard_Model->getgestioJudicialTotal($proceso, $etapa, $actuacion);
    ...
    public function historicoJudicialjson_SAP($proceso, $etapa, $actuacion, $fechaInicial=NULL, $fechaFInal = NULL){
        if($this->session->userdata('login_ok')){
            ini_set('memory_limit', '512M');

            $extrajudicial = $this->Wizard_Model->getgestioJudicialTotal_SAP($proceso, $etapa, $actuacion, $fechaInicial, $fechaFInal);
    ...
    function exportarHistoricoJudicial(){
        ini_set('memory_limit', '1024M');
        $judicial = $this->Wizard_Model->getgestioJudicialTotal();
