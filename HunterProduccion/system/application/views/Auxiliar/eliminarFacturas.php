<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Eliminar Facturas</li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">¿Qué tipo de eliminación desea hacer?</h3>
      <?php echo cambiar('José Ñiron') ?>
        </div>
        <div class="box-body">
            <div class="row">
	    ...
	    <div class="box-body">
            <form class="form-horizontal" action="<?php echo base_url(); ?>asignacion/carguemasABogados" method="POST" id="formCargeMasivoAbogados" enctype="multipart/form-data">
             <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Filtros</label>
                  <div class="col-sm-10">
	        ...
	        <div class="row" id="mostrarPorcentaje" style="display:none;">
	          ...
	          <div class="box-footer">
	            ...
	            <button type="button" id="btncarguedos" class="btn btn-primary">Eliminar Facturas</button>
	        </div><!-- /.box-footer -->
	    </div><!-- /.box -->
	</div>
    	...
    	<form class="form-horizontal" id="formSOlo" action="<?php echo base_url(); ?>asignacion/carguemasABogados" method="POST" enctype="multipart/form-data">
	        <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <input type="text"  name="txtnumeroLiquidacion" id="txtnumeroLiquidacion" class="form-control"> 
                  </div>
              </div>
	            <div class="form-group">
	                  <label for="inputEmail3" class="col-sm-2 control-label">Buscar por</label>
	            ...
	            <div class="form-group">
	                <label for="inputEmail3" class="col-sm-2 control-label">No. Factura</label>
	                <div class="col-sm-10">
	        ...
	        <div class="box-footer">
	            ...
	            <button type="button" id="botonSolo" class="btn btn-primary">Eliminar facturas</button>
	        </div><!-- /.box-footer -->
	    </form> 
	</div>
          ...
          if(validador == 0){
              alertify.confirm("¿Esta seguro de esta operación?", function (e) {
                if (e) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url(); ?>auxiliar/EliminarFacturaUnoUno',  
                        type: 'POST',
                        data: { txtnumeroSap :  $("#txtnumeroSap").val(),  filtro : $("#cmbFiltros2").val(), selPor : $("#cmbFiltrosMax").val(), liquidacion :  $("#txtnumeroLiquidacion").val()},
              ...
              alertify.confirm("¿Esta seguro de esta operación?", function (e) {
                  if (e) {
                    ...
                    $.ajax({
                        ...
                        url: '<?php echo base_url(); ?>auxiliar/EliminarFacturasMasivo',  
                        type: 'POST',
                        data: formData,
                        cache: false,
                        contentType: false,
                        ...
                        success: function(data){
                          if(data.valid == "1"){
                             alertify.success("La cantidad  de registros son "+ data.registros +", eliminados "+ data.total + ", " + data.noexisten + " no se pudieron eliminar porque no existen en la base de datos ");
                              otherForm[0].reset();
                            }
                        },
                        complete: function(){
              ...
              alertify.confirm("¿Esta seguro de esta operación?", function (e) {
                  if (e) {
                    ...
                    $.ajax({
                        ...
                        url: '<?php echo base_url(); ?>auxiliar/carguemasPoliza',  
                        type: 'POST',
                        data: formData,
                        cache: false,
                        contentType: false,
