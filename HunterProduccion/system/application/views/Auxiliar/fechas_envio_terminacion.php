<section class="content-header">
    <h1>
        CONFIGURACION - FECHA ENVÍO MEMORIAL DE TERMINACIÓN
    </h1>
    <ol class="breadcrumb">
    	<li><a href="<?php echo base_url();?>home">Inicio</a></li>
        <li class="active">Fecha envio memorial de terminación</li>
    </ol>
</section>
    ...
    <div class="box-body">
        ...
        <div class="row" id="mostrarPorcentaje" style="display:none;">
          ...
          <div class="box-footer">
            ...
            <button type="button" id="btncarguedos" class="btn btn-primary">Cargar la fecha</button>
        </div><!-- /.box-footer -->
    </div><!-- /.box -->
</div>
...
<div class="box" id="cargueunoaunoSki" style="display:none;">
    ...
    <form class="form-horizontal" id="formSOlo" action="<?php echo base_url(); ?>asignacion/carguemasABogados" method="POST" enctype="multipart/form-data">
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Fecha de envio memorial de terminación</label>
                <div class="col-sm-10">
        ...
        <div class="box-footer">
            ...
            <button type="button" id="botonSolo" class="btn btn-primary">Cargar la fecha</button>
        </div><!-- /.box-footer -->
    </form> 
</div>
          ...
          if(validador == 0){
              alertify.confirm("¿Esta seguro de esta operación?", function (e) {
                if (e) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url(); ?>auxiliar/SUperCargueABogados',  
                        type: 'POST',
                        data: { txtnumeroSap :  $("#txtnumeroSap").val(),  filtro : $("#cmbFiltros2").val(), txtfecha :  $("#txtfecha").val()},
              ...
              alertify.confirm("¿Esta seguro de esta operación?", function (e) {
                  if (e) {
                    ...
                    $.ajax({
                        ...
                        url: '<?php echo base_url(); ?>auxiliar/carguemasAbogadosSuperFNG',  
                        type: 'POST',
                        data: formData,
                        cache: false,
                        contentType: false,
