        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                	...
                	<div class="col-md-3">
	                	<div class="input-group">
							<label for="txtNumeroObligaciones">Nombre venta</label>
	                		<input type="text" class="form-control" id="txtNombreVenta" placeholder="Nombre venta">
						</div>
                	</div>
					<div class="col-md-3">
	                	<div class="input-group">
							<label for="txtNumeroObligaciones">Fecha venta</label>
	                		<input type="text" class="form-control" id="txtFechaVenta" placeholder="Fecha venta">
						</div>
                	</div>
					<div class="col-md-3">
	                	<div class="input-group">
							<label for="txtNumeroObligaciones">Fecha Notificación</label>
...
<script type="text/javascript">
		...
		$("#guardarParametros3").click(function(){
			if($("#txtNumeroObligaciones").val().length < 1){
				...
				$.ajax({
					...
					success: function(data){
						alertify.success("La cantidad  de registros son "+ data.registros +", guardados "+ data.total + ", " + data.baseAnte + " ya existian en la base de este año ");
	...
	function cambiarReporte(id){
		if(id == 5){
			...
			$.getJSON('<?php echo base_url();?>configuraciones/GetdatosRpeorte/'+id, {format: "json"}, function(data) { 
